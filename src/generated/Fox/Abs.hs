...
type Fun = Fun' BNFC'Position
data Fun' a = FunDef a (Type' a) Ident [Arg' a] (Block' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Arg = Arg' BNFC'Position
data Arg' a = ArgVar a (Type' a) Ident | ArgVal a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
instance HasPosition Fun where
  hasPosition = \case
    FunDef p _ _ _ _ -> p
